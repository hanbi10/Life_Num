...
tarotCard =  {0 : "0번 Fool (광대)" , 1 : "1번 Magician (마법사)" , 2 : "2번 The High Priestess (여사제)" , 3 : "3번 The Empress (여왕)", 4 : "4번 The Emperor (황제)", 5 : "5번 Hierophant (교황)" ,
              6 : "6번 The Lovers (연인들)" , 7 : "7번 The Chariot (전차)" , 8 : "8번 Strength (힘)" , 9  : "9번 The Hermit (은둔자)" , 10 : "10번 The Wheel Of Fortune (운명의 수레바퀴)" , 11 : "11번 Justice (정의)" , 12 : "12번 The Hanged Man (매달린 사람)" , 13 : "13번 Death (죽음)" ,
              14 : "14번 Temperance (절제)" , 15 : "15번 The Devil (악마)" , 16 : "16번 The Tower (탑)" , 17 : "17번 The Star (별)" , 18 : "18번 The Moon (달)" , 19 : "19번 The Sun (태양)" , 20 : "20번 Judgment (심판)" , 21 : "21번 The World (세계)"}
